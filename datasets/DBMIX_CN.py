...
def build_from_path_CN(hparams, speaker_num, lan_num, input_dir, meta_path, use_prosody, mel_dir, linear_dir, wav_dir, n_jobs=12, tqdm=lambda x: x):
	"""
	待补充TODO...
